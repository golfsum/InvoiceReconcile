...
export const metadata: Metadata = { title: "Page not found", description: "The requested InvoiceReconcile page could not be found.", robots: { index: false, follow: true }, alternates: { canonical: null } };
