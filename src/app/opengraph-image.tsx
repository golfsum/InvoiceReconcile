    ...
    <div style={{ width: "100%", height: "100%", display: "flex", background: "#f4f5f1", color: "#17201d", padding: 72, fontFamily: "Arial, sans-serif" }}>
      <div style={{ display: "flex", width: "100%", border: "2px solid #cdd4cf", background: "#ffffff" }}>
        <div style={{ width: "62%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: 58 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}><div style={{ fontSize: 62, lineHeight: 1.02, letterSpacing: "-3px", fontWeight: 700 }}>Stop matching invoice payments by hand.</div><div style={{ marginTop: 26, color: "#5e6b65", fontSize: 25, lineHeight: 1.4 }}>Import invoices and payments. Confirm responsible matches. Review only the exceptions.</div></div>
        ...
        <div style={{ width: "38%", display: "flex", flexDirection: "column", justifyContent: "center", padding: 45, background: "#15372a", color: "white" }}>
          <div style={{ fontSize: 18, color: "#9cdfbd", textTransform: "uppercase", letterSpacing: 2 }}>Northstar Services</div>
